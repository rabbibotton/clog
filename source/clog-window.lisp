...
(defmethod set-window-name ((obj clog-window) value)
  (execute obj (format nil "name='~A'" (escape-to-single-quote-in-tag value)))
  value)
...
(defmethod set-status-bar ((obj clog-window) value)
  (execute obj (format nil "status='~A'" (escape-to-single-quote-in-tag value)))
  value)
...
(defmethod set-inner-height ((obj clog-window) value)
  (execute obj (format nil "innerHeight='~A'" (escape-to-single-quote-in-tag value)))
  value)
...
(defmethod set-inner-width ((obj clog-window) value)
  (execute obj (format nil "innerWidth='~A'" (escape-to-single-quote-in-tag value)))
  value)
...
(defmethod set-outer-height ((obj clog-window) value)
  (execute obj (format nil "outerHeight='~A'" (escape-to-single-quote-in-tag value)))
  value)
...
(defmethod set-outer-width ((obj clog-window) value)
  (execute obj (format nil "outerWidth='~A'" (escape-to-single-quote-in-tag value)))
  value)
...
(defmethod set-x-offset ((obj clog-window) value)
  (execute obj (format nil "pageXOffset='~A'" (escape-to-single-quote-in-tag value)))
  value)
...
(defmethod set-y-offset ((obj clog-window) value)
  (execute obj (format nil "pageYOffset='~A'" (escape-to-single-quote-in-tag value)))
  value)
...
(defmethod set-top ((obj clog-window) value)
  (execute obj (format nil "screenY='~A'" (escape-to-single-quote-in-tag value)))
  value)
(defsetf top set-top)
...
(defmethod set-left ((obj clog-window) value)
  (execute obj (format nil "screenX='~A'" (escape-to-single-quote-in-tag value)))
  value)
...
(defmethod alert ((obj clog-window) message)
  (execute obj (format nil "alert('~A');" (escape-to-single-quote-in-js message))))
...
(defmethod log-console ((obj clog-window) message)
  (execute obj (format nil "console.log('~A')"
                       (escape-to-single-quote-in-js message))))
...
(defmethod storage-element ((obj clog-window) storage-type key-name)
  (query obj (format nil "~(~a~)Storage.getItem('~A')"
                     storage-type
                     (escape-to-single-quote-in-js key-name))))
